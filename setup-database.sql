...
CREATE POLICY "Allow all operations on visitor_requests" ON visitor_requests
  FOR ALL USING (true) WITH CHECK (true);

-- Create policies for guards
CREATE POLICY "Allow all operations on guards" ON guards
  FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all operations on temporary_guests" ON temporary_guests
  FOR ALL USING (true) WITH CHECK (true);
